...
using System.Xml;
 ...
 public class Exporter
 {
    ...
    public static string CLIENT_VER = "0_0_9_1";
    ...
    {
        EditorUtility.DisplayCancelableProgressBar("打包中...", "正在生成Version文件!", 0.9f);
        ...
        for(int i = 0; i < clientList.ChildNodes.Count; ++i)
        {
            ...
            else
            {
                ...
                string winDir = ExporterTools.GetRootDir(Exporter.VERSION_DIR) +"/乐多捕鱼3D_Data/";
